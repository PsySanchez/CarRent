...
namespace CarRent
{
  public static class Email
  {
    ...
    {
      Send("alex.varonin@gmail.com", subject, body);
    }
    ...
    {
      using (MailMessage msg2Send = new MailMessage("alex.varonin@gmail.com", toEmailAddress))
      {
        ...
        // Set credentials: 
        smtpClient.Credentials = new NetworkCredential("alex.varonin@gmail.com", "Pa$$w0rd0706");
